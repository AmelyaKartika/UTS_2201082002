 ...
 */
package com.amelya.Pembayaran.service;

import com.amelya.Pembayaran.entity.Pembayaran;
import com.amelya.Pembayaran.repository.PembayaranRepository;
import com.amelya.Pembayaran.vo.Order;
import com.amelya.Pembayaran.vo.ResponseTemplate;
...
@Autowired
    ...
    public void update(Long pembayaranId,String mode_pembayaran, String nomor_referensi, String tgl_bayar ){
     ...
     public ResponseTemplate getPembayaranWithOrderById(Long id){
         ...
         Order order = restTemplate.getForObject("http://localhost:9011/api/v1/order/" +pembayaran.getOrder_Id(), Order.class);
